...
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch --nproc_per_node=4 --master_port=29416  \
main_task_retrieval.py --do_train --num_thread_reader=4 \
--epochs=8 --batch_size=300 --n_display=50 \
--data_path ${DATA_PATH} \
--features_path ${DATA_PATH}/MSVD_Videos \
--output_dir ckpts/ckpt_msvd \
...
--use_hard_negative --hard_neg_margin "0.5" 